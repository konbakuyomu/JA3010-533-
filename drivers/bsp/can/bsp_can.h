...
#define CAN_FILTER1_ID_MASK (0x000000FFUL) // 探头1 ID掩码
#define CAN_FILTER1_ID_TYPE (CAN_ID_STD_EXT) /*接受标准帧和扩展帧*/

#define CAN_FILTER2_ID      (0x00004141UL) // 探头2 ID
#define CAN_FILTER2_ID_MASK (0x000000FFUL) // 探头2 ID掩码
#define CAN_FILTER2_ID_TYPE (CAN_ID_STD_EXT) /*接受标准帧和扩展帧*/

#define CAN_FILTER3_ID      (0x00004241UL) // 探头3 ID
#define CAN_FILTER3_ID_MASK (0x000000FFUL) // 探头3 ID掩码
#define CAN_FILTER3_ID_TYPE (CAN_ID_STD_EXT) /*接受标准帧和扩展帧*/

#define CAN_FILTER4_ID      (0x00004341UL) // 探头4 ID
#define CAN_FILTER4_ID_MASK (0x000000FFUL) // 探头4 ID掩码
#define CAN_FILTER4_ID_TYPE (CAN_ID_STD_EXT) /*接受标准帧和扩展帧*/
