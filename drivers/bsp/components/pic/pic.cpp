...
// 蜂鸣器图标数据
const std::vector<uint8_t> pic_buzzer = {
...
// 实时剂量图标数据
const std::vector<uint8_t> pic_realtime_dose = {
...
// 清除累积剂量图标数据
const std::vector<uint8_t> pic_clear_cumulative = {
    0xff, 0xff, 0xff, 0x3f, 0xff, 0xff, 0xff, 0x3f, 0xff, 0xff, 0xff, 0x3f, 0xff, 0xff, 0xff, 0x3f,
...
// 累积剂量图标数据
const std::vector<uint8_t> pic_cumulative_dose = {
